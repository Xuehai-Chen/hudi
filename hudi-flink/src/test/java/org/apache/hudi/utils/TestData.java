...
public class TestData {
  ...
  public static void assertRowsEquals(List<Row> rows, String expected, boolean withChangeFlag) {
    assertRowsEquals(rows, expected, 0, withChangeFlag);
  }
   ...
   */
  public static void assertRowsEquals(List<Row> rows, String expected, int orderingPos, boolean withChangeFlag) {
